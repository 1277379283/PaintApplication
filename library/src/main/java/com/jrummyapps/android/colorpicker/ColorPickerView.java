...
import activitys.paint.com.library.R;
...
public class ColorPickerView extends View {
  ...
  @Override public boolean onTouchEvent(MotionEvent event) {
    ...
    if (update) {
      if (onColorChangedListener != null) {
        onColorChangedListener.onColorChanged(Color.HSVToColor(alpha, new float[]{hue, sat, val}),alpha);
      }
      invalidate();
      return true;
    }
  ...
  public void setColor(int color, boolean callback) {
    ...
    if (callback && onColorChangedListener != null) {
      onColorChangedListener
          .onColorChanged(Color.HSVToColor(this.alpha, new float[]{hue, sat, val}),alpha);
    }
  ...
  public interface OnColorChangedListener {
    ...
    void onColorChanged(int newColor,int alpha);
  }
