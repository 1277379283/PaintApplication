...
public class InsertableObjectStroke extends InsertableObjectBase {
     ...
     * 画笔类型
     */
    protected int mStrokeType = STROKE_TYPE_PEN;
    ...
    public VisualElementBase createVisualElement(Context context,
        ...
        switch (this.mStrokeType) {
            case STROKE_TYPE_ERASER:
                visualElement = new VisualStrokeErase(context, internalDoodle, this,255);
                break;
            case STROKE_TYPE_NORMAL:
                visualElement = new VisualStrokePath(context, internalDoodle, this,mAlpha);

                break;
            case STROKE_TYPE_AIRBRUSH:
                visualElement = new VisualStrokeAirBursh(context, internalDoodle, this,mAlpha);
                break;
            case STROKE_TYPE_PENCIL:
                visualElement = new VisualStrokePencil(context, internalDoodle, this,mAlpha);
                break;
            case STROKE_TYPE_PEN:
                visualElement = new VisualStrokePen(context, internalDoodle, this,mAlpha);
                break;
            case STROKE_TYPE_BRUSH:
                visualElement = new VisualStrokeBrush(context, internalDoodle, this,mAlpha);
                break;
            case STROKE_TYPE_MARKER:
                visualElement = new VisualStrokeMarker(context, internalDoodle, this,mAlpha);
                break;
            default:
                break;
        }
